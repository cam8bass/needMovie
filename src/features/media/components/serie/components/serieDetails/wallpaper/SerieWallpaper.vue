...
import SerieWallpaperNav from "./SerieWallpaperNav.vue";
import SerieBackdrop from "./SerieBackdrop.vue";
import SeriePoster from "./SeriePoster.vue";
...
<template>
  <div class="sectionDetail">
    <SerieWallpaperNav
      ...
      @update-navigation="updateWallpaperNavigation"
    />
    <SerieBackdrop
